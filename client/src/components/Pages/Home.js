    ...
    <>
      ...
      <div className="row" style={{ marginTop: "35px" }}>
        <div className="col-lg-4 align-items-center d-flex justify-content-center">
          <div className="white border-0" style={{ width: "30rem" }}>
      ...
      <div className="gpt3__blog section__padding" id="blog">
              <div className="gpt3__blog-heading">
                <h1 className="gradient__text">Exceptional experiences with FAST Airways</h1>
                <h5 className="gradient__text text-center"> Explore the world, earn rewards and live the best adventures with FAST Airways.{" "}
            </h5>
              </div>
      </div>
      <div className="row">
